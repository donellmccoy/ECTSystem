...
-- Author:		?
-- Create date: ?
-- Description:	Performs a select on the LOD Form348 table filtering records
--				based on various pieces of search criteria passed into the 
--				procedure. (Pagination version)
-- ============================================================================
-- Modified By:		Ken Barnett
-- Modified Date:	11/27/2015
-- Work Item:		TFS Task 289
-- Description:		Changed the size of @caseID from 16 to 50.
-- ============================================================================
-- Modified By:		Ken Barnett
...
-- Description:		- Changes the @status parameter to @statusCode. This
--					parameter now represents the StatusCode ID instead of the
--					WorkStatus ID. Update the SELECT condition to properly use
--					this parameter.
-- ============================================================================
-- Modified By:		Ken Barnett
-- Modified Date:	1/10/2017
-- Description:		- Modified to now use the fn_IsUserTheMember() function when
--					checking if the user and member match.
-- ============================================================================
-- Modified By:		Ken Barnett
-- Modified Date:	3/1/2017
-- Description:		- Modified to no longer select legacy restricted SARC 
--					cases.
-- ============================================================================
-- Modified By:		Ken Barnett
...
-- Description:		StatusCodes are now stored in INTs
-- ============================================================================
...
-- ============================================================================
CREATE PROCEDURE [dbo].[form348_sp_Search_pagination]
		  @caseID VARCHAR(50) = null
		, @ssn VARCHAR(9) = null
		, @name VARCHAR(50) = null
		, @statusCode INT = null		-- StatusCode Id; NOT WorkStatus Id
		, @userId  INT
		, @rptView TINYINT
