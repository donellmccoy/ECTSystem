...
CREATE PROCEDURE [dbo].[cmdStructChain_sp_GetChaninByUserId]
(
	@userId int,
	@viewType int
)
...
DECLARE @cs_id INT, @csc_id INT, @userPasCode VARCHAR(10)
...
SELECT   DISTINCT  b.cs_id as Value,  b.long_name + ' (' + b.pas_code + ')'as Name
FROM 
