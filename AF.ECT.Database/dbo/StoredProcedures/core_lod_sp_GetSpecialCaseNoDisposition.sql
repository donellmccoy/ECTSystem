...
-- Description:	Displays all cases except Disposition step in My Cases page
...
-- Description:		Ordered the results based on the Days column
...
-- ============================================================================
CREATE PROCEDURE [dbo].[core_lod_sp_GetSpecialCaseNoDisposition]
	@moduleId INT,
	@userId INT
AS
