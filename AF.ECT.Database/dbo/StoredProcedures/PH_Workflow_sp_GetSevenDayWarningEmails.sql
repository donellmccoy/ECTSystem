...
-- Description:	Returns emails for the Unit PH users which have not either 
--				started or completed the current month's PH form.
-- ============================================================================
-- Modified By:		Ken Barnett
-- Modified Date:	6/29/2017
-- Description:		Removed the RMU filter.
-- ============================================================================
CREATE PROCEDURE [dbo].[PH_Workflow_sp_GetSevenDayWarningEmails]
	@executionYear INT,
	@executionMonth INT
AS
BEGIN
	...
	-- FIGURE OUT WHICH UNITS REQUIRE THE 7 DAY WARNING EMAIL TO BE SENT --
	SET @currentUnitId = 0
