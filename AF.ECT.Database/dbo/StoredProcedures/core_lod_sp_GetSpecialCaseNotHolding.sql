...
-- Description:	Displays all cases except Holding step in My Cases page
--				Modified version of core_lod_sp_GetSpecialCasesByModuleId				
-- ============================================================================
-- Edited By:	Evan Morrison
-- Edit date:	3/30/2017
-- Description:	Add NE Holding step			
-- ============================================================================
-- Edited By:	Evan Morrison
-- Edit date:	4/3/2017
-- Description:	Return the workflow title		
-- ============================================================================
-- Edited By:	Gary Colbert
-- Edit date:	11/15/2019
-- Description:	add compo		
-- ============================================================================
...
-- Modified Date:	05/04/2020
-- Description:		Added column 'Reporting_Period' to Special Cases
-- ============================================================================

CREATE PROCEDURE [dbo].[core_lod_sp_GetSpecialCaseNotHolding]
	@moduleId INT,
	@userId INT
AS

-- Test
-- exec [dbo].[core_lod_sp_GetSpecialCaseNotHolding] 23, 105
...
SELECT	DISTINCT sc_id
		...
		, CASE 
			...
			ELSE ''
		END AS PriorityRank
		, ISNULL(Format(fsc.ph_reporting_period,'MM/dd/yyyy','en-US'),'') AS Reporting_Period
FROM	Form348_SC fsc
