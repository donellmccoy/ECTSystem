...
-- Author:		?
-- Create date: ?
-- Description:	Performs an in consult case search all on Form348 table (Pagination version)
-- ============================================================================
...
-- ============================================================================
CREATE PROCEDURE [dbo].[form348_sp_InConsultCaseSearch_all_pagination]
