...
-- Description:	Returns the immediate children for the specified unit by
--				searching the reporting view unit hierarchy as defined by the
--				Command_Struct_Chain table.
-- ============================================================================
CREATE PROCEDURE [dbo].[cmdStruct_sp_GetImmediateChildrenForUnit]
	@unitId INT,
	@rptView INT
AS
BEGIN
