...
-- Description:	Executes the LOD Suspsense Monitoring canned report.
-- ============================================================================
...
--					unit.
-- ============================================================================
CREATE PROCEDURE [dbo].[report_sp_LODSuspsenseMonitoring]
	@unitId INT,
	@rptView INT,
...
BEGIN
	...
	INSERT	INTO	@Results ([RefId], [CaseId], [StatusId], [Status], [MemberName], [MemberUnit], [UnitId], [IsFormal], [DaysInCurrentStatus], [DaysOpen])
			SELECT	l.lodId AS RefId, l.[Case Id] AS CaseId, vws.statusId, l.Status, l.[Member Name] AS MemberName, l.[Member Unit] AS MemberUnit, l.member_unit_id AS UnitId,
					CASE
						WHEN l.Formal = 'No' THEN 0
						ELSE 1
					END AS IsFormal,
					l.Days AS DaysInCurrentStatus,
					CASE 
	...
	BEGIN
		SELECT	r.UnitId AS UnitId, r.MemberUnit AS MemberUnit,
				...
				r.DaysInCurrentStatus AS DaysInCurrentStatus,
