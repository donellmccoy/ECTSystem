...
-- Description:	Performs a search of the Appeal Request cases.
-- ============================================================================
...
-- ============================================================================
CREATE PROCEDURE [dbo].[form348_AP_sp_Search]
...
BEGIN
	...
	INSERT	INTO	#TempSearchData
			SELECT	a.appeal_id AS RefId,
					...
					CONVERT(VARCHAR, a.appeal_id) + ', ' + CONVERT(VARCHAR, w.moduleId) AS PrintId,
					s.statusId,
