...
-- Author:		?
-- Create date: ?
-- Description:	Performs a post appeal completion search on Form348 table (Pagination version)
-- ============================================================================
...
-- ============================================================================
CREATE PROCEDURE [dbo].[form348_sp_PostAppealCompletionSearch_pagination]
