...
-- Description:	Determines if the specified LOD case has been fully completed 
--				(i.e. the final determination memo has been created and the 
--				member has bee notified).
-- ============================================================================
...
-- ============================================================================
CREATE FUNCTION [dbo].[fn_IsLODFullyCompleted]
(
	@refId INT
)
RETURNS BIT
...
BEGIN
	...
	WHERE	
			...
			(
				ws.isCancel = 1
				OR
				f.is_post_processing_complete = 1
			)
