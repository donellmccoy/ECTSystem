...
-- Description:	Determines if the specified Restricted SARC Appeal case has 
...
--					in favor of checking the is_post_processing_complete
...
-- ============================================================================
CREATE FUNCTION [dbo].[fn_IsRestrictedSARCAppealFullyCompleted]
(
	@refId INT
)
RETURNS BIT
