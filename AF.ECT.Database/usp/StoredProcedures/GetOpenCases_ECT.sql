...
CREATE PROCEDURE [usp].[GetOpenCases_ECT]
AS
-- ====================================================================================
-- Author:		Eric Kelley
...
SELECT @reportStartDate 'Report Start Date',
...
--AND wst.startDate > @testDate -- change @testDate to @reportStartDate
AND (wst.EndDate BETWEEN @startDate AND @endDate OR (wst.EndDate IS NULL)) AND wst.endDate IS NULL 
...
--ORDER BY wst.startDate DESC--'Case_Id'
------------------------------------------------------------------------------------------------------
------ for Med Rev --------------------------------------------------------------
SELECT COUNT(*) AS 'Med Rev'
FROM	
core_WorkStatus_Tracking wst
JOIN core_WorkStatus ws ON wst.ws_id = ws.ws_id
JOIN core_StatusCodes sc ON ws.statusId = sc.statusId
